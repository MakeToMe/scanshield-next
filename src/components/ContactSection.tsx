  ...
  return (
    <section className="py-16 bg-dark-darker">
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="bg-[#13122b] border border-[#2e2d4c] rounded-xl p-8 shadow-lg">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-3 py-3 bg-[#1e1d3c] border border-[#2e2d4c] rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
            ...
            <div>
              ...
              <textarea
                ...
                rows={5}
                className="block w-full px-4 py-3 bg-[#1e1d3c] border border-[#2e2d4c] rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
